...
if ($user_id != "" && $password != ""){
    ...
    $sql = "select *from user where user_id = '$user_id' and password = '$password' and type = '$user_type'"; 
    ...
    if($count == 1){
		...
		$_SESSION['type'] = 'user';
		header('Location: user_dashboard.php');
        //echo "<h3>Hi ".$row['name']." You have login successfully.</h3>";
    }else{
...
?></span></a>
    ...
    <tbody><tr bgcolor="#95A5A6">
		...
		<td align="center" width="640"><font color="white" size="+2"><b>User Login Form</b></font></td>
    ...
    <tbody><tr bgcolor="#32AADA">
    	<td style="padding-top: 5px;padding-bottom: 2px;">&nbsp;&nbsp;
    		...
    		<a href="register.php"><img src="img/reg.jpg" width="55" height="40"></a>
    	</td>
    </tr>
    <tr>
		<td style="padding-left: 20px;"><br>You are here:
		<a href="parcelhome.jsp?enc=&quot;en&quot;" style="text-decoration: none;">Home </a>&gt;&gt;
		<a style="text-decoration: none;font-size: 20px;">User Login Form</a>
		</td>
	</tr>
    </tbody></table>
    <!-- Start of Input form -->
    <table width="800" align="center" cellpadding="0" cellspacing="0">
		<tbody><tr>
	  		 <td bgcolor="white" align="center" width="400" height="300">
	       			...
	       			<tbody><tr> 
 		       			<td align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>User Id:</b></font></td>
 		       			<td><input type="text" name="user_id" id="user_id" value="" maxlength="5" required></td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;a. Enter user id and Password to login.<br>		
			</td>
			</tr>
